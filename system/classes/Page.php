...
class Page extends Entity {
    ...
    同ページ別言語データ取得
    *******************************/
    function getLangPage($page_id, $page_id_lang) {
        $base_data = $this->getPageData($page_id);
        $lang_data = $this->getPageData($page_id_lang);
        ...
        $lang_data['slide_photo'] = $base_data['slide_photo'];
    ...
    *******************************/
    function update($data_list, $data) {
        ...
        $params['keyword_tag'] = $data['keyword_tag'];
