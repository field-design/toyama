...
<div class="status-info section">
    ...
    <div class="columns section">
        <div class="column is-3">
            {include file=$smarty.const.ADMIN_DIR|cat:'includes/aside/menu.tpl' area='is-active' is_admin=$is_admin}
        </div>
        <div class="column is-9">
<!-- START main -->
<main>

    <h2 class="title is-3">エリア編集</h2>

    <section id="edit_area" class="input-area">

        <div class="conts-body message-body">

            <label class="label">エリア
                <span class="help">最大30件</span>
            </label>
            <div id="area_container" class="control sortable">
                <p class="control has-addons">
                    <a class="button">
                      <i class="fa fa-navicon"></i>
                    </a>
                    <input class="input is-expanded" type="text" placeholder="例：タクシー乗車代" value="魚津市">
                ...
                <p class="control has-addons">
                    ...
                    <input class="input is-expanded" type="text" placeholder="例：タクシー乗車代" value="黒部市">
                    <a class="button remove" onclick="((this).parentNode.remove())">
                      <i class="fa fa-close"></i>
                    </a>
                </p>
                <p class="control has-addons">
                    ...
                    <input class="input is-expanded" type="text" placeholder="例：タクシー乗車代" value="入善町">
                    <a class="button remove" onclick="((this).parentNode.remove())">
                      <i class="fa fa-close"></i>
                    </a>
                </p>
                <p class="control has-addons">
                    ...
                    <input class="input is-expanded" type="text" placeholder="例：タクシー乗車代" value="朝日町">
                    <a class="button remove" onclick="((this).parentNode.remove())">
                      <i class="fa fa-close"></i>
                    </a>
                </p>
...
<script>
    $(function() {
        ...
        ****************************/
        ...
        $('#edit_area .add-btn a').click(function(){
            partsapi.addParts('area', '#area_container');
        });
    });
</script>
{/literal}
