...
<div class="status-info section">
    ...
    <div class="columns section">
        <div class="column is-3">
            {include file=$smarty.const.ADMIN_DIR|cat:'includes/aside/menu.tpl' category='is-active' is_admin=$is_admin}
        </div>
        <div class="column is-9">
<!-- START main -->
<main>

    <h2 class="title is-3">カテゴリ編集</h2>

    <section id="edit_category" class="input-area">

        <div class="conts-body message-body">

            <label class="label">カテゴリ
                <span class="help">最大30件</span>
            </label>
            <div class="control sortable" id="category_container">
                <p class="control has-addons">
                    <a class="button">
                      <i class="fa fa-navicon"></i>
                    </a>
                    <input class="input is-expanded" type="text" placeholder="例：タクシー乗車代" value="体験する">
                ...
                <p class="control has-addons">
                    ...
                    <input class="input is-expanded" type="text" placeholder="例：タクシー乗車代" value="見る">
                    <a class="button remove" onclick="((this).parentNode.remove())">
                      <i class="fa fa-close"></i>
                    </a>
                </p>
                <p class="control has-addons">
                    ...
                    <input class="input is-expanded" type="text" placeholder="例：タクシー乗車代" value="食べる">
                    <a class="button remove" onclick="((this).parentNode.remove())">
                      <i class="fa fa-close"></i>
                    </a>
                </p>
                <p class="control has-addons">
                    ...
                    <input class="input is-expanded" type="text" placeholder="例：タクシー乗車代" value="買う">
                    <a class="button remove" onclick="((this).parentNode.remove())">
                      <i class="fa fa-close"></i>
                    </a>
                </p>
...
<script>
    $(function() {
        ...
        ****************************/
        ...
        $('#edit_category .add-btn a').click(function(){
            partsapi.addParts('category', '#category_container');
        });
    });
</script>
{/literal}
