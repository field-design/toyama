    ...
    <table class="product-list table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="product-edit"><a class="button is-primary is-outlined" href="{$smarty.const.URL_ROOT_PATH_ADMIN}product/price/setting/?ProductID={$data.product_id}">代金設定</a></td>
            </tr>
            {/foreach}
          </tbody>
        </table>
