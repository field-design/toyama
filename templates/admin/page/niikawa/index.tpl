...
<div class="container">
    ...
    <div class="columns section">
        <div class="column is-3 is-hidden-mobile">
            {if $data.page_id == 4}
                {include file=$smarty.const.ADMIN_DIR|cat:'includes/aside/menu.tpl' page_niikawa_en='is-active' is_admin=$is_admin}
            {else}
                {include file=$smarty.const.ADMIN_DIR|cat:'includes/aside/menu.tpl' page_niikawa='is-active' is_admin=$is_admin}
            {/if}
        </div>
