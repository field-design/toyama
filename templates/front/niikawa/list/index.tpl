...
<title>ツアーの一覧 |  {Constant::$siteNameNiikawa}</title>
            ...
            <ul>
                {foreach from=$pager item=value}
                    {if $value == ($current_page - 2) && $current_page != count($pager) || ($current_page == count($pager) && $value == $current_page - 3)}
                        <li class="prev"><a href="{$smarty.const.URL_ROOT_PATH}niikawa/list/?page={$current_page - 1}{$area|default:''}{$category|default:''}">前へ</a></li>
                    ...
                    {elseif $value == ($current_page + 2) && $current_page != 1 || ($current_page == 1 && $value == $current_page + 3) }
                        <li class="next"><a href="{$smarty.const.URL_ROOT_PATH}niikawa/list/?page={$current_page + 1 }{$area|default:''}{$category|default:''}">次へ</a></li>
