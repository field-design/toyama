                ...
                <ul class="drawer-menu">
                    ...
                    <li class="nav-dropdown">
                        ...
                        <ul class="drawer-dropdown-menu">
                            <li><a href="{$smarty.const.URL_ROOT_PATH}niikawa/list/?area=1">魚津市</a></li>
                            <li><a href="{$smarty.const.URL_ROOT_PATH}niikawa/list/?area=2">黒部市</a></li>
                            <li><a href="{$smarty.const.URL_ROOT_PATH}niikawa/list/?area=3">入善町</a></li>
                            <li><a href="{$smarty.const.URL_ROOT_PATH}niikawa/list/?area=4">朝日町</a></li>
                        </ul>
                    </li>
                    <li class="nav-dropdown ddm-last">
                        <a href="#" data-toggle="dropdown">ジャンルでえらぶ</a>
                        <ul class="drawer-dropdown-menu">
                            <li><a href="{$smarty.const.URL_ROOT_PATH}niikawa/list/?Category=1">体験する</a></li>
                            <li><a href="{$smarty.const.URL_ROOT_PATH}niikawa/list/?Category=2">見る</a></li>
                            <li><a href="{$smarty.const.URL_ROOT_PATH}niikawa/list/?Category=3">食べる</a></li>
                            <li><a href="{$smarty.const.URL_ROOT_PATH}niikawa/list/?Category=4">買う</a></li>
                        </ul>
                    </li>
